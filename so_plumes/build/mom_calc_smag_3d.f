...
C     S23   :: Squared of strain component Vyz @ above vVel
      INTEGER i, j
      INTEGER kl, n
      Real*8 twoThird, tmpFac, locVisc
      Real*8 S66(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8 S12(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8 S13(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8 S23(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
...
C--  ------------------------------------------------------------------
      ...
      IF ( k.EQ.1 ) THEN
        DO j=1-OLy,sNy+OLy
         DO i=1-OLx,sNx+OLx
           viscAh3d_13(i,j,k) = 0.D0
           viscAh3d_23(i,j,k) = 0.D0
         ENDDO
        ENDDO
      ENDIF
