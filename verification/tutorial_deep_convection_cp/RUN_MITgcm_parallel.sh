#!/bin/bash
#SBATCH --account=nwg_sos.p_so-clim 	##needs to be set according to what accounts you're allowed to use
#SBATCH -J mpirun			##job name
#SBATCH --qos=30min			##needs to be set explicitly; controls queuing
#SBATCH -t 0-0:30			##job time limit
